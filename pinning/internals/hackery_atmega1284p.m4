...
#define TC1_MODE_PWMFAST_ICR {TCCR1A|=_BV(WGM11);TCCR1A&=~(_BV(WGM10));TCCR1B|=(_BV(WGM12))|(_BV(WGM13));}
...
#define TC1_OUTPUT_COMPARE_B_NONE   {TCCR1A&=~(_BV(COM1B1)|_BV(COM1B0));}
#define TC1_OUTPUT_COMPARE_B_TOGGLE {TCCR1A&=~(_BV(COM1B1));TCCR1A|=_BV(COM1B0);}
#define TC1_OUTPUT_COMPARE_B_CLEAR  {TCCR1A&=~(_BV(COM1B0));TCCR1A|=_BV(COM1B1);}
#define TC1_OUTPUT_COMPARE_B_SET    {TCCR1A|=_BV(COM1B1)|_BV(COM1B0);}

#define TC1_COUNTER_CURRENT  TCNT1
#define TC1_COUNTER_COMPARE  OCR1A
#define TC1_COUNTER_COMPARE_B  OCR1B
#define TC1_INPUT_CAPTURE     ICR1

#define TC1_INT_COMPARE_ON   TIMSK1|=_BV(OCIE1A);
#define TC1_INT_COMPARE_OFF  TIMSK1&=~_BV(OCIE1A);
#define TC1_INT_COMPARE_B_ON   TIMSK1|=_BV(OCIE1B);
#define TC1_INT_COMPARE_B_OFF  TIMSK1&=~_BV(OCIE1B);
...
#define TC1_VECTOR_COMPARE_B   TIMER1_COMPB_vect
...
#define TC3_MODE_PWMFAST_ICR {TCCR3A|=_BV(WGM31);TCCR3A&=~(_BV(WGM30));TCCR3B|=(_BV(WGM32))|(_BV(WGM33));}
...
#define TC3_OUTPUT_COMPARE_B_NONE   {TCCR3A&=~(_BV(COM3B1)|_BV(COM3B0));}
#define TC3_OUTPUT_COMPARE_B_TOGGLE {TCCR3A&=~(_BV(COM3B1));TCCR3A|=_BV(COM3B0);}
#define TC3_OUTPUT_COMPARE_B_CLEAR  {TCCR3A&=~(_BV(COM3B0));TCCR3A|=_BV(COM3B1);}
#define TC3_OUTPUT_COMPARE_B_SET    {TCCR3A|=_BV(COM3B1)|_BV(COM3B0);}

#define TC3_COUNTER_CURRENT  TCNT3
#define TC3_COUNTER_COMPARE  OCR3A
#define TC3_COUNTER_COMPARE_B  OCR3B
#define TC3_INPUT_CAPTURE     ICR3

#define TC3_INT_COMPARE_ON   TIMSK3|=_BV(OCIE3A);
#define TC3_INT_COMPARE_OFF  TIMSK3&=~_BV(OCIE3A);
#define TC3_INT_COMPARE_B_ON   TIMSK3|=_BV(OCIE3B);
#define TC3_INT_COMPARE_B_OFF  TIMSK3&=~_BV(OCIE3B);
...
#define TC3_VECTOR_COMPARE_B   TIMER3_COMPB_vect
